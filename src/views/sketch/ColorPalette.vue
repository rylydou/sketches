...
.swatch {
	...
	// this method has better animations and keeps the box shape better...
	box-shadow:
		inset 0 -4px 0 0 hsl(0 0% 0% / 0.5),
		inset 0 0px 0 0 white;
	// ...than this method:
	// box-shadow:
	// 0 4px 0 0 hsl(0 0% 0% / 0.5),
